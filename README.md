...
Finally, evaluate() usually produces these statements saying 'No statements were generated in the answer' and skips ahead. I'm not really sure what its doing, so I'm going to raise an issue on the github and ask. My current theory of this is that if an llm is passed as an arg, it might say this and cause the metric to be unusually high.


In other words, the evaluation results REALLY depend on the args passed to the metrics.
